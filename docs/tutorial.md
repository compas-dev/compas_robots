...
the [COMPAS FAB](https://compas.dev/compas_fab/latest/) extension
...
coordinate frames, which are described using the [Frame][compas.geometry.Frame] class.
...
![Coordinate frame convention of a robotic setup.](files/coordinate_frames.jpg)
...
[Transformation][compas.geometry.Transformation] between the two:
...
Robot models are represented by the [RobotModel][compas_robots.RobotModel] class.
...
and `add_joint` of [RobotModel][compas_robots.RobotModel] offer an alternative that
...
aware that the class [RobotModel][compas_robots.RobotModel] can be used,
...
![Boxy with one box link.](files/boxy_1.png)
...
primitives such as [Box][compas.geometry.Box] or the more complex
COMPAS meshes [Mesh][compas.datastructures.Mesh]. For simplicity,
...
![Boxy with shifted box.](files/boxy_2.png)
...
![Boxy with stacked boxes.](files/boxy_3.png)
...
![Jointy with two links and a joint.](files/jointy.png)
...
[ROS (Robot Operating System)](https://www.ros.org/) is a very complex and
...
[here](https://compas.dev/compas_fab/latest/backends/ros.html).
...
[COMPAS FAB](https://compas.dev/compas_fab/latest/).
